...
export const pricingCards = [
  {
    title: 'FREE',
    description: 'Run Unlimited Manual Events',
    price: 'Free',
    duration: '',
    highlight: 'Key features',
    features: ['3 Live Events', '2 Team members', 'Unlimited leaderboards'],
    priceId: 'price_1OuKDFIad6m3wlrKLEGEF4mU',
  },
  {
    title: 'HypeGamer Elite',
    description: 'Full Esports Suite + A.I.',
    price: '$199',
    duration: 'month',
    highlight: 'Key features',
    features: ['Unlimited Real Time Events', 'No Team Limit, Real Time A.I.'],
    priceId: 'price_1OuKIKIad6m3wlrKdMQs4qg4',
  },
  {
    title: 'HypeGamer Plus',
    description: 'Scalable Real Time Events + A.I.',
    price: '$49',
    duration: 'month',
    highlight: 'Everything in Starter, plus',
    features: ['Unlimited Live Events', 'Unlimited Team members'],
    priceId: 'price_1OuKI1Iad6m3wlrKy2aW8E5c',
  },
]
